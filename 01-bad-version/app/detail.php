...
<div class="card m-4" style="width:30%">
    ...
    <div class="card-body">
        ...
        <hr>
        <p>Période du séjour: Du <?php echo date('d-m-Y', strtotime($annonce['date_start'])); ?> au
            <?php echo date('d-m-Y', strtotime($annonce['date_end'])); ?></p>
        ...
        <div class="d-flex justify-content-between mt-2 ">
            ...
            <form action="reservation_post.php" method="get">
                ...
                <button type="submit" class="btn btn-success col-5">Choisir ce séjour</button>
            </form>
            <?php
                }
            ?>
        ...
        <div class="d-flex justify-content-between mt-2 ">
            <a href="modifier-annonces.php?id=<?php echo $annonce['location_id']; ?>"
                class="btn btn-warning col-5">Modifier l'annonce</a>
            <a href="delete.php?id=<?php echo $annonce['location_id']; ?>" class="btn btn-danger col-5">Supprimer
                l'annonce</a>
        </div>
    </div>
</div>
